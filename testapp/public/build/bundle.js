...
var app = (function (exports) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 61, 0, 1513);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class RouterNestedOutlet extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*router*/ ctx[0] === undefined && !("router" in props)) {
    			console_1.warn("<RouterNestedOutlet> was created without expected prop 'router'");
    		}
    	}
    ...
    var Router = /** @class */ (function () {
        ...
        Router.prototype.parseRoute = function (url) {
            ...
            var nestingFrom = ((_a = this.currentRoute) === null || _a === void 0 ? void 0 : _a.nestingFrom) || 0;
            if (!matchedRoute) {

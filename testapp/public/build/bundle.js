    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 48, 0, 1353);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 28, 0, 641);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	(async () => {
    		...
    		if (router && router._nested && router._nested.component) {
    			$$invalidate(0, comp = router._nested.component);
    			await callback("in");
    			$$invalidate(1, passingRouter = JSON.parse(JSON.stringify(router)));
    			$$invalidate(1, passingRouter._nested = router._nested.nested || false, passingRouter);
    		}
    	})();
    	...
    	return [comp, passingRouter, router, callback];
    }

    class RouterNestedOutlet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { router: 2, callback: 3 });
    		...
    		if (/*callback*/ ctx[3] === undefined && !("callback" in props)) {
    			console.warn("<RouterNestedOutlet> was created without expected prop 'callback'");
    		}
    	}

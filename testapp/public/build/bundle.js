...
var app = (function (exports) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 51, 0, 1397);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	function switch_props(ctx) {
    		return {
    			props: { router: /*passingRouter*/ ctx[0] },
    			$$inline: true
    		};
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$5, 47, 0, 1226);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	(async () => {
    		...
    		if (router && router.currentRoute.routeObject.nested && router.currentRoute.routeObject.nested.component) {
    			$$invalidate(5, comp = false);
    			await delay(2);
    			await callback("out");
    			$$invalidate(5, comp = router.currentRoute.routeObject.nested.component);
    			await callback("in");
    			$$invalidate(0, passingRouter = JSON.parse(JSON.stringify(router)));
    			$$invalidate(0, passingRouter._nested = router.currentRoute.routeObject.nested.nested || false, passingRouter);
    		}
    	})();
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$2.warn(`<RouterNestedOutlet> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("router" in $$props) $$invalidate(3, router = $$props.router);
    		if ("callback" in $$props) $$invalidate(4, callback = $$props.callback);
    		if ("comp" in $$props) $$invalidate(5, comp = $$props.comp);
    ...
    class RouterNestedOutlet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { router: 3, callback: 4 });
    		...
    		if (/*router*/ ctx[3] === undefined && !("router" in props)) {
    			console_1$2.warn("<RouterNestedOutlet> was created without expected prop 'router'");
    		}

    		if (/*callback*/ ctx[4] === undefined && !("callback" in props)) {
    			console_1$2.warn("<RouterNestedOutlet> was created without expected prop 'callback'");
    		}
    	}
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<ParamsPlayground> was created with unknown prop '${key}'`);
    	});
    ...
    class ParamsPlayground extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentRoute*/ ctx[0] === undefined && !("currentRoute" in props)) {
    			console_1$3.warn("<ParamsPlayground> was created without expected prop 'currentRoute'");
    		}
    	}
    ...
    var Router = /** @class */ (function () {
        ...
        Router.prototype.parseRoute = function (url) {
            ...
            var transitionDepth = Matched.transitionDepth;
            if (!matchedRoute) {

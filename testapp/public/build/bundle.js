...
var app = (function (exports) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (switch_instance) create_component(switch_instance.$$.fragment);
    			attr_dev(div, "class", "svelte-easyroute-outlet");
    			add_location(div, file$4, 10, 0, 188);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<RouterNestedOutlet> was created with unknown prop '${key}'`);
    	});
    ...
    class RouterNestedOutlet extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*route*/ ctx[0] === undefined && !("route" in props)) {
    			console_1.warn("<RouterNestedOutlet> was created without expected prop 'route'");
    		}
    	}
    ...
    // (29:20) {#each Object.keys(currentRoute.query) as key}
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(" ... ");
    			t2 = text(t2_value);
    			add_location(p, file$5, 29, 24, 854);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(29:20) {#each Object.keys(currentRoute.query) as key}",
    		ctx
    	});
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a1.textContent = "Home page";
    			attr_dev(h3, "class", "text-center");
    			add_location(h3, file$5, 15, 4, 356);
    			add_location(h50, file$5, 20, 16, 546);
    			add_location(pre0, file$5, 21, 16, 585);
    			attr_dev(div0, "class", "col-md-4");
    			add_location(div0, file$5, 19, 12, 507);
    			add_location(h51, file$5, 26, 16, 718);
    			add_location(pre1, file$5, 27, 16, 757);
    			attr_dev(div1, "class", "col-md-4");
    			add_location(div1, file$5, 25, 12, 679);
    			add_location(h52, file$5, 34, 16, 1018);
    			attr_dev(a0, "href", "https://github.com/lyohaplotinka/svelte-easyroute");
    			add_location(a0, file$5, 35, 19, 1053);
    			add_location(p0, file$5, 35, 16, 1050);
    			attr_dev(a1, "href", "https://lyoha.info/en/projects/svelterouter");
    			add_location(a1, file$5, 36, 19, 1147);
    			add_location(p1, file$5, 36, 16, 1144);
    			attr_dev(div2, "class", "col-md-4");
    			add_location(div2, file$5, 33, 12, 979);
    			attr_dev(div3, "class", "row");
    			add_location(div3, file$5, 18, 8, 477);
    			attr_dev(div4, "class", "container-fluid mt-5");
    			add_location(div4, file$5, 17, 4, 434);
    			attr_dev(div5, "class", "container-fluid index-page mt-3");
    			add_location(div5, file$5, 14, 0, 306);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Test extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*currentRoute*/ ctx[0] === undefined && !("currentRoute" in props)) {
    			console_1$1.warn("<Test> was created without expected prop 'currentRoute'");
    		}

    		if (/*router*/ ctx[3] === undefined && !("router" in props)) {
    			console_1$1.warn("<Test> was created without expected prop 'router'");
    		}

    		if (/*nested*/ ctx[1] === undefined && !("nested" in props)) {
    			console_1$1.warn("<Test> was created without expected prop 'nested'");
    		}
    	}
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 6, 0, 144);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Nested extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*route*/ ctx[0] === undefined && !("route" in props)) {
    			console_1$3.warn("<Nested> was created without expected prop 'route'");
    		}
    	}

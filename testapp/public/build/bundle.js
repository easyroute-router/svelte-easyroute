...
var app = (function (exports) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 22, 0, 563);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	router.afterUpdate = () => {
    		$$invalidate(4, _routeComponent = false);

    		setTimeout(
    			() => {
    				$$invalidate(4, _routeComponent = router.currentRoute.routeObject.component);
    				$$invalidate(5, _routeInfo = router.currentRoute.routeInfo);
    			},
    			2
    		);
    	};
    	...
    	$$self.$inject_state = $$props => {
    		if ("router" in $$props) $$invalidate(3, router = $$props.router);
    		if ("_routeComponent" in $$props) $$invalidate(4, _routeComponent = $$props._routeComponent);
    		if ("_routeInfo" in $$props) $$invalidate(5, _routeInfo = $$props._routeInfo);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty[0] & /*_routeComponent*/ 16) {
    			 $$invalidate(1, routeComponent = _routeComponent);
    		}

    		if ($$self.$$.dirty[0] & /*_routeInfo*/ 32) {
    			 $$invalidate(2, routeInfo = _routeInfo);
    		}
    	};

    	return [passingRouter, routeComponent, routeInfo, router];
    }

    class RouterOutlet extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { router: 3 });
    ...
    function create_fragment$4(ctx) {
    	...
    	function switch_props(ctx) {
    		return {
    			props: { router: /*passingRouter*/ ctx[1] },
    			$$inline: true
    		};
    	}
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			const switch_instance_changes = {};
    			if (dirty[0] & /*passingRouter*/ 2) switch_instance_changes.router = /*passingRouter*/ ctx[1];
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$1.warn(`<RouterNestedOutlet> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => {
    		return { router, comp, passingRouter };
    	};

    	$$self.$inject_state = $$props => {
    		if ("router" in $$props) $$invalidate(2, router = $$props.router);
    		if ("comp" in $$props) $$invalidate(0, comp = $$props.comp);
    		if ("passingRouter" in $$props) $$invalidate(1, passingRouter = $$props.passingRouter);
    	};

    	return [comp, passingRouter, router];
    }
    ...
    class RouterNestedOutlet extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*router*/ ctx[2] === undefined && !("router" in props)) {
    			console_1$1.warn("<RouterNestedOutlet> was created without expected prop 'router'");
    		}
    	}
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(nestedoutlet.$$.fragment);
    			add_location(h1, file$7, 6, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$3.warn(`<Nested> was created with unknown prop '${key}'`);
    	});
    ...
    class Nested extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*router*/ ctx[0] === undefined && !("router" in props)) {
    			console_1$3.warn("<Nested> was created without expected prop 'router'");
    		}
    	}
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			create_component(nestedoutlet.$$.fragment);
    			add_location(h1, file$8, 6, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	let { router } = $$props;
    	console.log("deeeep", router);
    	const writable_props = ["router"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1$4.warn(`<NestedDeep> was created with unknown prop '${key}'`);
    	});
    ...
    class NestedDeep extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*router*/ ctx[0] === undefined && !("router" in props)) {
    			console_1$4.warn("<NestedDeep> was created without expected prop 'router'");
    		}
    	}

...
var Router = /** @class */ (function () {
        ...
        switch (this.mode) {
            ...
            case 'history':
                ...
                window.addEventListener('popstate', function (ev) {
                    ev.state ? _this.parseRoute(PathService_1.default.stripBase(ev.state.url, _this.base), false) : _this.parseRoute('/', false);
                });
                break;
            case 'hash':
            default:
    ...
    Router.prototype.go = function (howFar) {
        ...
        if (this.mode !== 'silent') {
            ...
            (_a = this.silentControl) === null || _a === void 0 ? void 0 : _a.go(howFar);
        }
    };

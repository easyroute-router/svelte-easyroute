...
var Router = /** @class */ (function () {
        ...
        switch (this.mode) {
            case 'history':
                ...
                window.addEventListener('popstate', function (ev) {
                    ev.state ? _this.parseRoute(ev.state.url) : _this.parseRoute('/');
                });
                break;
            case 'hash':
            default:
                ...
                window.addEventListener('hashchange', function () {
                    ...
                    _this.parseRoute(window.location.hash);
                });
                break;
        }
    };
    Router.prototype.getTo = function (matched, url) {
        ...
        if (!currentRoute)
            return null;
        return UrlParser_1.default.createRouteObject([currentRoute], url);
    };
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!allowNext)
                            return [2 /*return*/];
                        this.changeUrl(url);
                        this.currentRouteData.setValue(UrlParser_1.default.createRouteObject(matched, url));

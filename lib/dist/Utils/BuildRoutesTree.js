...
function getRoutesTreeChain(allRoutes, currentId) {
  ...
  var currentRoute = allRoutes.find(function (route) {
    return route.id === currentSeekingIds
  })
  var _loop_1 = function () {
    var currentRoute_1 = allRoutes.find(function (route) {
      return route.id === currentSeekingIds
    })
    if (currentRoute_1) {
      var seed = allRoutes.find(function (route) {
        return route.id === currentRoute_1.parentId
      })
      if (seed) {
        tree.push(seed)
